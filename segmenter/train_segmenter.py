...
def load_image_train(datapoint):
  input_image = tf.image.resize(datapoint['image'], (192, 192))
  input_mask = tf.image.resize(datapoint['segmentation_mask'], (192, 192))
...
up_stack = [
    ...
    pix2pix.upsample(192, 3),  # 16x16 -> 32x32
...
image = tf.keras.preprocessing.image.load_img('../image_management/content/YellowLabradorLooking_new.jpg')
...
pred = tf.image.resize(pred_mask, [192, 192])
display([image[0], create_mask(pred)])
